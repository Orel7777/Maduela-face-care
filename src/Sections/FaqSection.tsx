...
const faqItems: FaqItem[] = [
  {
    ...
    answer: 'בטיפול הראשון נתחיל בהיכרות קצרה – תספרי לי על העור שלך, מה מטריד אותך ומה ניסית בעבר. אחר כך אבצע אבחון מקצועי ונבנה יחד תוכנית טיפול מותאמת אישית. הטיפול עצמו כולל ניקוי עמוק, הזנה ומסכה, והכל באווירה רגועה ונעימה.',
  },
  {
    id: 'faq-2',
    question: 'אחרי כמה זמן רואים שינוי בעור?',
    answer: 'רוב הלקוחות מרגישות שיפור כבר אחרי הטיפול הראשון – העור רך יותר, זוהר ונקי. לתוצאות משמעותיות יותר כמו טיפול בפיגמנטציה, קמטים או אקנה, מומלץ תהליך של מספר טיפולים יחד עם שגרת טיפוח בבית.',
  },
  {
    id: 'faq-3',
    question: 'האם הטיפול מתאים גם לעור רגיש?',
    answer: 'בהחלט! אני מתמחה בטיפול בעורות רגישים, אדמומיים ומגורים. כל הטיפולים מותאמים אישית עם מוצרים עדינים ובטכניקות שלא פוגעות בעור. הרבה לקוחות עם עור רגיש מגיעות אליי אחרי שלא הצליחו במקומות אחרים.',
  },
  {
    id: 'faq-4',
    question: 'כמה עולה טיפול פנים?',
    answer: 'המחירים משתנים לפי סוג הטיפול: טיפול ניקוי עמוק מ-350₪, טיפול זוהר לאירוע מ-400₪, וטיפול לעור רגיש מ-380₪. יש גם חבילות וסדרות טיפולים במחיר מוזל. מוזמנת לפנות אליי לייעוץ חינם ונמצא את הטיפול המתאים לך.',
  },
  {
    id: 'faq-5',
    question: 'כמה זמן נמשך טיפול?',
    answer: 'טיפול פנים סטנדרטי נמשך בין 60 ל-90 דקות, תלוי בסוג הטיפול ובמצב העור. אני לא ממהרת – חשוב לי שתצאי רגועה וזוהרת, לא לחוצה.',
  },
  {
    id: 'faq-6',
    question: 'איך קובעים תור?',
    answer: 'הכי קל לפנות אליי בוואטסאפ או להשאיר פרטים בטופס באתר. אני מחזירה תשובה תוך כמה שעות ונתאם יחד תאריך ושעה שנוחים לך. תורים זמינים בימים א׳-ה׳.',
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-20" dir="rtl">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#5b4f47] leading-tight mb-6">
            יש לך שאלה?
            <span className="block text-[#a06c3b]">כנראה שיש לנו תשובה</span>
          </h2>
          
          <p className="text-base sm:text-lg text-[#5b4f47]/80 leading-relaxed">
            אספתי את השאלות הכי נפוצות שלקוחות שואלות לפני הטיפול הראשון.
            <span className="font-medium text-[#5b4f47]"> לא מצאת תשובה? תמיד אפשר לשאול אותי ישירות.</span>
          </p>
        </motion.div>
            ...
            <div className="sticky top-32 space-y-6">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-[#5b4f47] to-[#695125] text-white">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white text-brand-ink font-semibold text-sm hover:font-bold hover:bg-[#ddc1a7] transition-all w-full justify-center"
                >
