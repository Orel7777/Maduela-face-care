            ...
            <div className="sticky top-32 space-y-6">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-[#5b4f47] to-[#695125] text-white">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white text-[#5b4f47] font-semibold text-sm hover:font-bold hover:bg-[#ddc1a7] transition-all w-full justify-center"
                >
