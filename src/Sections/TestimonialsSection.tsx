...
const TestimonialsSection: React.FC = () => {
  ...
  const featuredReviews = [
    {
      text:
        'הגעתי לטיפול עם עור עייף וחסר חיים ויצאתי עם זוהר אמיתי. דקלה סופר מקצועית ומרגישים שהיא יודעת בדיוק מה העור צריך.',
      name: 'לקוחות הקליניקה',
      title: 'נס ציונה',
      rating: '5.0',
    },
    {
      text:
        'חוויה מרגיעה ומדויקת. הטיפול היה עדין אבל אפקטיבי, וההסברים היו ברורים. ממליצה בחום למי שמחפשת תוצאה אמיתית.',
      name: 'לקוחות הקליניקה',
      title: 'טיפול פנים',
      rating: '5.0',
    },
    {
      text:
        'שירות מדהים ויחס אישי. כבר מהטיפול הראשון הרגשתי שינוי במרקם של העור. המקום נקי, נעים ומפנק.',
      name: 'לקוחות הקליניקה',
      title: 'תוצאה כבר מהטיפול הראשון',
      rating: '5.0',
    },
  ];
